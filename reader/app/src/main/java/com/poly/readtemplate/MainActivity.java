...
import com.poly.readtemplate.ui.read.ReadActivity;
import com.poly.readtemplate.utils.Utils;

public class MainActivity extends BaseActivity {

    final String mContent = " 大漠孤烟直，长河落日圆。㈧㈠Δ』中文网Ｗｗ％Ｗ．ん８⒈Ｚｗ．ＣＯＭ\n" +
            "\n" +
            ...
            "    当时他并未在意。\n" +
            "\n" +
            "    依旧宁静，沙漠中除却多了一层朦胧的蓝雾，并没有其他变故生，楚风加快脚步，他想尽快离开这里。\n" +
            "\n" +
            "    大漠的尽头，落日蓝的妖异，染蓝了西部的天空，不过它终究快要消失在地平线上了。\n" +
            "\n" +
            "    楚风的度越来越快，开始奔跑，他不想呆在这种诡异、充满不确定性的地方。\n" +
            "\n" +
            "    在沙漠中，海市蜃楼那样的奇景多生在烈日当空下，眼下不相符，这不像是什么蜃景。\n" +
            "\n" +
            ...
            "\n" +
            "    短暂的停滞，随后沙沙声成片，蓝色灿灿，所有嫩苗都快拔高，一瞬间生长起来。\n" +
            "\n" +
            ...
            "    一缕淡淡的芬芳飘漾，让人沉迷。\n" +
            "\n" +
            "    楚风用力摇头，小心的迈步，避开这些花，他现只有一个地带没有这种植物，那就是———黄河古道。\n" +
            "\n" +
            ...
            "\n" +
            "    楚风站在黄河古道上，心中无法宁静，但是他却不作停留，沿河道快前进。\n" +
            "\n" +
            "    天色渐暗，最后的落日余晖也已不见了。\n" +
            "\n" +
            "    蓝色的大漠光彩点点，而后突然间，砰然一声，所有蓝色彼岸花怒放后，竟然在一瞬间同时凋零。\n" +
            "\n" +
            "    妖艳的花瓣枯萎，接着整株的植物开始干枯，它们失去色彩，耗尽生机，迅黄，而后碎裂，像是在一瞬间失去了数十年。\n" +
            "\n" +
            "    “砰！”\n" +
            "\n" +
            ...
            "\n" +
            "    枯黄的粉末落在沙地间，在暮色中很难辨出，而此时蓝雾也早已消失，大漠恢复了原样，像是什么都不曾生过，再次宁静。\n" +
            "\n" +
            ...
            "\n" +
            "    山地前方，灯火摇曳，离山脚下还较远时就听到了一些嘈杂声，那里不平静，像是有什么事情正在生。\n" +
            "\n" +
            "    此外，还有牛羊等牲畜惶恐的叫声，以及藏獒沉闷的低吼声。\n" +
            "\n" +
            "    有异常之事吗？楚风加快脚步，赶到山脚下，临近牧民的栖居地。";

    private ViewPager mReaderPager;
    @Override
    ...
    public void goRead(View view){
        ReadActivity.start(this,mContent);
    }
